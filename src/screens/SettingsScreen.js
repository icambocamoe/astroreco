...
export const SettingsScreen = ({ navigation, route }) => {
  ...
  const CambiarTema = (tema /* : string */) => {
    switch (tema) {
      case "claro00":
        setThemeData(TemaClaro00);
        break;
      case "claro01":
        setThemeData(TemaClaro01);
        break;
      case "claro02":
        setThemeData(TemaClaro02);
        break;
      case "claro03":
        setThemeData(TemaClaro03);
        break;
      case "claro04":
        setThemeData(TemaClaro04);
        break;
      case "claro05":
        setThemeData(TemaClaro05);
        break;
      case "claro06":
        setThemeData(TemaClaro06);
        break;
      case "claro07":
        setThemeData(TemaClaro07);
        break;
      case "claro08":
        setThemeData(TemaClaro08);
        break;
      case "claro09":
        setThemeData(TemaClaro09);
        break;
      case "claro10":
        setThemeData(TemaClaro10);
        break;
      case "oscuro00":
        setThemeData(TemaOscuro00);
        break;
      case "oscuro01":
        setThemeData(TemaOscuro01);
        break;
      case "oscuro02":
        setThemeData(TemaOscuro02);
        break;
      case "oscuro03":
        setThemeData(TemaOscuro03);
        break;
      case "oscuro04":
        setThemeData(TemaOscuro04);
        break;
      case "oscuro05":
        setThemeData(TemaOscuro05);
        break;
      case "oscuro06":
        setThemeData(TemaOscuro06);
        break;
      case "oscuro07":
        setThemeData(TemaOscuro07);
        break;
      case "oscuro08":
        setThemeData(TemaOscuro08);
        break;
      case "oscuro09":
        setThemeData(TemaOscuro09);
        break;
      case "oscuro10":
        setThemeData(TemaOscuro10);
        break;
    }
  };
